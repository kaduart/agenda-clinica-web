                                                ...
                                                {!showOnlyFree && (
                                                    <>
                                                        ...
                                                        {slots.map((t) => {
                                                            ...
                                                            if (!apt) return null; // Mostra tudo, inclusive cancelados

                                                            const isCanceled = apt.status === "Cancelado" || apt.status === "desistiu" || apt.status === "descartado";
